...
from src.physics import acceleration, step_semi_implicit, step_explicit, energy, step_rk4
...
plt.title("Energy conservation: Symplectic vs RK4 (dt=0.05)")
plt.legend()
...
plt.xlabel("x (AU)")
plt.ylabel("y (AU)")
plt.title("Earth's orbit: Symplectic vs Forward Euler vs RK4 (dt=0.05)")
plt.legend()
plt.grid(True, alpha=0.3)
